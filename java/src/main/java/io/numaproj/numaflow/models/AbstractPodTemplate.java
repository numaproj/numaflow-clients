...
public class AbstractPodTemplate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, imagePullSecrets, metadata, nodeSelector, priority, priorityClassName, runtimeClassName, securityContext, serviceAccountName, tolerations);
  }
