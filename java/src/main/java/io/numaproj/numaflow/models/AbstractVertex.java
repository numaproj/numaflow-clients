...
public class AbstractVertex {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, containerTemplate, imagePullSecrets, initContainerTemplate, initContainers, limits, metadata, name, nodeSelector, priority, priorityClassName, runtimeClassName, scale, securityContext, serviceAccountName, sidecars, sink, source, tolerations, udf, volumes);
  }
