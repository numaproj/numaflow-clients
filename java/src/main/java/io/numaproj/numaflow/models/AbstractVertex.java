...
public class AbstractVertex {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, containerTemplate, imagePullSecrets, initContainerTemplate, initContainers, limits, metadata, name, nodeSelector, priority, priorityClassName, scale, securityContext, serviceAccountName, sink, source, tolerations, udf, volumes);
  }
