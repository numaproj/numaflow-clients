...
public class DaemonTemplate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, containerTemplate, imagePullSecrets, initContainerTemplate, metadata, nodeSelector, priority, priorityClassName, replicas, runtimeClassName, securityContext, serviceAccountName, tolerations);
  }
