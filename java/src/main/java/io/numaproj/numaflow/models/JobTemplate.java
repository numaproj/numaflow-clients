...
public class JobTemplate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, backoffLimit, containerTemplate, imagePullSecrets, metadata, nodeSelector, priority, priorityClassName, runtimeClassName, securityContext, serviceAccountName, tolerations, ttlSecondsAfterFinished);
  }
