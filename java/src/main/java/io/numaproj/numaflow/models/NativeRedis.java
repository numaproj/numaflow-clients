...
public class NativeRedis {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `redisContainerTemplate` to the URL query string
    if (getRedisContainerTemplate() != null) {
      joiner.add(getRedisContainerTemplate().toUrlQueryString(prefix + "redisContainerTemplate" + suffix));
    }
    ...
    // add `sentinelContainerTemplate` to the URL query string
    if (getSentinelContainerTemplate() != null) {
      joiner.add(getSentinelContainerTemplate().toUrlQueryString(prefix + "sentinelContainerTemplate" + suffix));
    }
