...
public class NativeRedis {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, imagePullSecrets, initContainerTemplate, metadata, metricsContainerTemplate, nodeSelector, persistence, priority, priorityClassName, redisContainerTemplate, replicas, runtimeClassName, securityContext, sentinelContainerTemplate, serviceAccountName, settings, tolerations, version);
  }
