...
public class Scale {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "TargetBufferUsage is used to define the target percentage of the buffer availability. A valid and meaningful value should be less than the BufferUsageLimit defined in the Edge spec (or Pipeline spec), for example, 50. It only applies to UDF and Sink vertices because only they have buffers to read. Deprecated: use targetBufferAvailability instead. Will be removed in v0.9")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cooldownSeconds, disabled, lookbackSeconds, max, min, replicasPerScale, targetBufferAvailability, targetBufferUsage, targetProcessingSeconds, zeroReplicaSleepSeconds);
  }
