...
public class Source {
  ...
  public static final String JSON_PROPERTY_NATS = "nats";
  private NatsSource nats;

  public static final String JSON_PROPERTY_TRANSFORMER = "transformer";
  private UDTransformer transformer;
  ...
  **/
  ...
  public Source nats(NatsSource nats) {
    this.nats = nats;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NATS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNats(NatsSource nats) {
    this.nats = nats;
  }


  public Source transformer(UDTransformer transformer) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TRANSFORMER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransformer(UDTransformer transformer) {
    this.transformer = transformer;
  }


  public Source udsource(UDSource udsource) {
    this.udsource = udsource;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_UDSOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUdsource(UDSource udsource) {
    this.udsource = udsource;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.generator, source.generator) &&
        ...
        Objects.equals(this.nats, source.nats) &&
        Objects.equals(this.transformer, source.transformer) &&
        Objects.equals(this.udsource, source.udsource);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generator, http, kafka, nats, transformer, udsource);
  }
  ...
  public String toString() {
    ...
    sb.append("    udsource: ").append(toIndentedString(udsource)).append("\n");
    sb.append("}");
    return sb.toString();
  }
