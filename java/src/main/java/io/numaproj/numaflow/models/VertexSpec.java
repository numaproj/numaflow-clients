...
public class VertexSpec {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, automountServiceAccountToken, containerTemplate, dnsConfig, dnsPolicy, fromEdges, imagePullSecrets, initContainerTemplate, initContainers, interStepBufferServiceName, limits, metadata, name, nodeSelector, pipelineName, priority, priorityClassName, replicas, runtimeClassName, scale, securityContext, serviceAccountName, sidecars, sink, source, toEdges, tolerations, udf, volumes, watermark);
  }
