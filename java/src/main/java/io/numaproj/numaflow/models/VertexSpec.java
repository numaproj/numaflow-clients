...
public class VertexSpec {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinity, containerTemplate, fromEdges, imagePullSecrets, initContainerTemplate, initContainers, interStepBufferServiceName, limits, metadata, name, nodeSelector, pipelineName, priority, priorityClassName, replicas, scale, securityContext, serviceAccountName, sink, source, toEdges, tolerations, udf, volumes, watermark);
  }
