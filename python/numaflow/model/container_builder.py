...
def lazy_import():
    from numaflow.model.v1_container_port import V1ContainerPort
    from numaflow.model.v1_env_from_source import V1EnvFromSource
    from numaflow.model.v1_env_var import V1EnvVar
    from numaflow.model.v1_lifecycle import V1Lifecycle
    from numaflow.model.v1_probe import V1Probe
    from numaflow.model.v1_resource_requirements import V1ResourceRequirements
    from numaflow.model.v1_security_context import V1SecurityContext
    from numaflow.model.v1_volume_device import V1VolumeDevice
    from numaflow.model.v1_volume_mount import V1VolumeMount
...
class ContainerBuilder(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """ContainerBuilder - a model defined in OpenAPI
