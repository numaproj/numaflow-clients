...
class DaemonTemplate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DaemonTemplate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            replicas (int): Replicas is the number of desired replicas of the Deployment. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#what-is-a-replicationcontroller. [optional]  # noqa: E501
