...
class GetRedisServiceSpecReq(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, labels, redis_container_port, sentinel_container_port, *args, **kwargs):  # noqa: E501
        """GetRedisServiceSpecReq - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, labels, redis_container_port, sentinel_container_port, *args, **kwargs):  # noqa: E501
        """GetRedisServiceSpecReq - a model defined in OpenAPI
