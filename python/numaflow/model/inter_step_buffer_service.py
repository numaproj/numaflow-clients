...
def lazy_import():
    ...
    from numaflow.model.v1_object_meta import V1ObjectMeta
    globals()['InterStepBufferServiceSpec'] = InterStepBufferServiceSpec
    globals()['InterStepBufferServiceStatus'] = InterStepBufferServiceStatus
    globals()['V1ObjectMeta'] = V1ObjectMeta


class InterStepBufferService(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'spec': (InterStepBufferServiceSpec,),  # noqa: E501
            'api_version': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
            'metadata': (V1ObjectMeta,),  # noqa: E501
            'status': (InterStepBufferServiceStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, spec, *args, **kwargs):  # noqa: E501
        """InterStepBufferService - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (InterStepBufferServiceStatus): [optional]  # noqa: E501
        """
