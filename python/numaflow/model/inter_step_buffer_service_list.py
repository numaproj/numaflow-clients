...
def lazy_import():
    ...
    from numaflow.model.v1_list_meta import V1ListMeta
    globals()['InterStepBufferService'] = InterStepBufferService
    globals()['V1ListMeta'] = V1ListMeta


class InterStepBufferServiceList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([InterStepBufferService],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, metadata, *args, **kwargs):  # noqa: E501
        """InterStepBufferServiceList - a model defined in OpenAPI

        Args:
            items ([InterStepBufferService]):
            metadata (V1ListMeta):
