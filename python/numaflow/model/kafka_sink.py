...
class KafkaSink(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, topic, *args, **kwargs):  # noqa: E501
        """KafkaSink - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, topic, *args, **kwargs):  # noqa: E501
        """KafkaSink - a model defined in OpenAPI
