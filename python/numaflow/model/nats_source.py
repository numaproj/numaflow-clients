...
def lazy_import():
    ...
    globals()['NatsAuth'] = NatsAuth
    globals()['TLS'] = TLS


class NatsSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, queue, subject, url, *args, **kwargs):  # noqa: E501
        """NatsSource - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            auth (NatsAuth): [optional]  # noqa: E501
            tls (TLS): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, queue, subject, url, *args, **kwargs):  # noqa: E501
        """NatsSource - a model defined in OpenAPI
