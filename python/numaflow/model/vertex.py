...
def lazy_import():
    ...
    globals()['VertexSpec'] = VertexSpec
    globals()['VertexStatus'] = VertexStatus


class Vertex(ModelNormal):
    ...
    def _from_openapi_data(cls, spec, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (VertexStatus): [optional]  # noqa: E501
        """
